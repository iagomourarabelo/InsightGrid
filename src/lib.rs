...
#[derive(Debug)]
pub struct InsightGridProcessor {
    verbose: bool,
    processed_count: usize,
}

impl InsightGridProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting InsightGrid processing");
    
    let mut processor = InsightGridProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = InsightGridProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = InsightGridProcessor::new(false);
